    ...
    return (
        <div className='px-12 lg:px-24 mx-auto'>
            ...
            <div className='bg-primary rounded-3xl p-8 text-primary-foreground mb-10'>
                <div className='mb-6'>
                    <h2 className='text-2xl font-bold mb-4'>Contact met Het Span</h2>
                    <p className='text-xl flex items-center mb-2'>
                        Medische diensten:
                        <Link href='/' className='hover:text-secondary-foreground flex flex-row items-center ml-2'>
                            <p className='underline italic cursor-pointer flex items-center'>
                                Klik hier
                            </p>
                        </Link>
                    </p>
